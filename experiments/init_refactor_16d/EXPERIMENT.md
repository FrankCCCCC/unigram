...
with `V·d`. Measured at `batch=2048` on an RTX A6000, `hyper_dim = 16`:

| `ps` | V | train s/step | test s/batch | peak train GiB |
|---|---|---|---|---|
| `naive_ps` / `cmplx_ps` | 10 | ~0.022 | ~0.013 | 0.4 |
| `c1e3_exp1.0` | 1 000 | 0.061 | 0.0339 | 2.1 |
| `c1e4_exp1.0` | 10 000 | 0.565 | 0.3011 | 20.9 |
...
- `c1e4_exp1.0` at `hyper_dim = 16` — excluded: `desa-compute-01` (11 GB), `kuleshov-compute-03` (24 GB).
...
At the measured rate, per project: **~258 GPU-h** for `c1e3_exp1.0` and
**~2400 GPU-h** for `c1e4_exp1.0`
— **~2659 GPU-h** for this project, ~5300 GPU-h across the three
