...
the same three curvatures {-0.01, -10.0, -1.0}, but carried by three
simultaneous factors of one model instead of three separate models. Each factor contributes its own intrinsic radius, and the model input is
