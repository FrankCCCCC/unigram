#!/usr/bin/env python
"""init_refactor_9d sweep: init_test's grid on the GENERAL-d bridge at hyper_dim=9.

Grid is exactly experiments/init_refactor_9d/setup.md:
...
Run this from a LOGIN node (compute nodes have no slurm.conf):
    cd <repo> && python experiments/init_refactor_9d/sweep.py --dry-run
    python experiments/init_refactor_9d/sweep.py
"""
