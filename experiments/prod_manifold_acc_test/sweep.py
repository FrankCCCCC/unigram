...
class ProductCurvatureProject(Project):
    ...
    def excluded_nodes(self, ps: str, geom: str = "pp") -> str:
        ...
        # `geom` is accepted and ignored: the base class sizes cross_entropy and
        # poincare_polar separately (PEAK_GB_CE), so it passes the geometry down,
        # but this project gates on partition features instead of node names.
        return ""
