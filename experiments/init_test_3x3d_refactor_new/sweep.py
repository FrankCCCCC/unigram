...
against init_test_3d_refactor_new's nine single-manifold curvatures; the
eighth, [-0.01,-10.0,-1.0], is the MIXED one -- three radii inside one model. Each factor contributes its own intrinsic radius,
and the model input is (rho_1, rho_2, rho_3) plus the concatenated unit
directions, so D = 9.
